...
var sdkParityCoverageManifest = []sdkParityCoverageRequirement{
	...
	{"mutation", "public liblql seekable and callback-source candidate-stream mutation behavior matches Go mutation stream behavior for current NDJSON corpus", []string{"TestSDKMutationFileRangeCandidateStreamParity"}},
	...
	{"streaming", "public liblql file and callback-source decision stream summaries match Go query stream summaries for current NDJSON and repeated-value stream corpus", []string{"TestSDKStreamingDecisionParity"}},
