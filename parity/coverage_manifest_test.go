...
var cliParityCoverageManifest = []cliParityCoverageRequirement{
	...
	{"streaming", "matched stdin output for NDJSON streams", []string{"TestCLQLStdinOutputStreamingParity"}},
	{"streaming", "matched seekable file output for NDJSON streams", []string{"TestCLQLSeekableFileOutputParity"}},
	...
	{"mutation", "match-all mixed candidate stream mutation non-flattening contract", []string{"TestCLQLMatchAllMutationMixedStreamContract"}},
