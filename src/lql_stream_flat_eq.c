...
static void lql_flat_eq_cache_recursive_match(lql_json_flat_eq_term *term) {
  ...
  term->path_recursive_match_plain = lql_flat_eq_plain_segment(
      term->path_recursive_match, term->path_recursive_match_len);
}
...
lql_status lql_stream_apply_flat_eq(lql *self,
                                    const lql_stream_request *request,
                                    lql_stream_result *result, lql_error *error,
                                    int allow_spool, int *out_handled) {
