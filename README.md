...
through `lql_mutation_plan`, and supported root-field mutations can be applied
to seekable file ranges without full-document materialization. Nested mutation
execution, payload handles, and full `clql` parity are still active porting
work.
